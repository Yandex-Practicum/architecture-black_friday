...
# Дополнительные подключения к шардам
shard_clients = {
    "shard1": AsyncIOMotorClient("mongodb://shard1-1:27018,shard1-2:27018,shard1-3:27018/?replicaSet=shard1"),
    "shard2": AsyncIOMotorClient("mongodb://shard2-1:27018,shard2-2:27018,shard2-3:27018/?replicaSet=shard2"),
    "config": AsyncIOMotorClient("mongodb://configSrv-1:27019,configSrv-2:27019,configSrv-3:27019/?replicaSet=configSrv")
}
