# Шардирование MongoDB с репликами (Схема 2)

Конфигурация: один mongos-роутер, конфиг-сервер с тремя репликами (Primary + 2 Replica), два шарда каждый с тремя репликами (Primary + 2 Replica).
...
docker compose up -d configsvr configsvr1 configsvr2 shard1 shard1_1 shard1_2 shard2 shard2_1 shard2_2
...
**5. Подождать ~5 секунд и запустить роутер:**
...
Приложение подключается к mongodb://mongos:27017.