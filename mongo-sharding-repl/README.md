# MongoDB Sharding with Replication (Задание 3)

В данном каталоге реализована отказоустойчивая схема шардирования MongoDB:
...
- В интерфейсе вы увидите 3 реплики для каждого шарда.