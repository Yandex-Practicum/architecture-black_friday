...
В этом проекте делаем MongoDB с шардированием и репликацией. У каждого шарда по 3 копии (1 основная + 2 резервные) чтобы все работало даже если что-то сломается.
