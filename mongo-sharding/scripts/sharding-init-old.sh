...
echo " - Документов на Shard 1:"
docker exec -i shard1 mongosh "mongodb://localhost:27018/somedb" --eval '
  db.helloDoc.countDocuments()
'
echo " - Документов на Shard 2:"
docker exec -i shard2 mongosh "mongodb://localhost:27019/somedb" --eval '
  db.helloDoc.countDocuments()
'
